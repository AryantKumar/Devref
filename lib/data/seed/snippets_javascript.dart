...
console.log(doubled, evens);'''..language='javascript'..difficulty='very_easy'..section='Functions'..isSaved=false..lastViewedAt=null,
...
console.log(highlight`Hello \${name}, you are \${age}`);'''..language='javascript'..difficulty='very_easy'..section='Data Types and Variables'..isSaved=false..lastViewedAt=null,
...
display({ name: "Bob" });'''..language='javascript'..difficulty='very_easy'..section='Data Types and Variables'..isSaved=false..lastViewedAt=null,
...
console.log("Any available:", anyAvailable);'''..language='javascript'..difficulty='very_easy'..section='Arrays and Collections'..isSaved=false..lastViewedAt=null,
...
console.log(dog instanceof Animal); // true'''..language='javascript'..difficulty='very_easy'..section='Objects and Classes'..isSaved=false..lastViewedAt=null,
...
console.log(port, host, count, val);'''..language='javascript'..difficulty='very_easy'..section='Conditional Expressions'..isSaved=false..lastViewedAt=null,
...
Promise.allSettled([fetchUser(1), fetchUser(-1)])
  ...
  ));'''..language='javascript'..difficulty='medium'..section='Async Programming'..isSaved=false..lastViewedAt=null,
...
console.log([...union], [...intersection]);'''..language='javascript'..difficulty='medium'..section='Arrays and Collections'..isSaved=false..lastViewedAt=null,
...
// export { default as Logger } from "./logger.js";'''..language='javascript'..difficulty='medium'..section='Modules'..isSaved=false..lastViewedAt=null,
...
processOnce(item); // Already processed: 1'''..language='javascript'..difficulty='medium'..section='Arrays and Collections'..isSaved=false..lastViewedAt=null,
...
console.log(pass, fail);'''..language='javascript'..difficulty='medium'..section='Arrays and Collections'..isSaved=false..lastViewedAt=null,
...
main();'''..language='javascript'..difficulty='hard'..section='Async Programming'..isSaved=false..lastViewedAt=null,
...
errorLog("Something failed");'''..language='javascript'..difficulty='hard'..section='Functions'..isSaved=false..lastViewedAt=null,
...
}'''..language='javascript'..difficulty='hard'..section='Async Programming'..isSaved=false..lastViewedAt=null,
...
}'''..language='javascript'..difficulty='hard'..section='Concurrency'..isSaved=false..lastViewedAt=null,
...
// acc.#balance; // SyntaxError!'''..language='javascript'..difficulty='hard'..section='Objects and Classes'..isSaved=false..lastViewedAt=null,
...
// lock.lock();
// // critical section
// lock.unlock();'''..language='javascript'..difficulty='very_hard'..section='Concurrency'..isSaved=false..lastViewedAt=null,
...
}'''..language='javascript'..difficulty='very_easy'..section='Standard Library'..isSaved=false..lastViewedAt=null,
